...
const Product = ({ image, name, price, description, handleChange, role, addToBasket, inBasket }) => (
			...
			<div className="col-lg-5 mb-2">
				<div className="card" style={{ minHeight: '430px' }}>
					<div className="card-body">
						...
						<div className="row justify-content-around align-items-center ml-2">
							{role === 'admin' ? null : <ButtonBasket addToBasket={addToBasket} inBasket={inBasket} />}
						</div>
					</div>
				</div>
			</div>
...
const ButtonBasket = ({ addToBasket, inBasket }) => (
	<div className="row justify-content-around align-items-center ml-2">
