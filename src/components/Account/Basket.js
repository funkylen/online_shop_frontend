				...
				<div className="card mb-4" style={{ padding: '10px', minWidth: '200px' }}>
					<div className="row no-gutters align-items-center">
						<div className="col-md-3">
							<img src={ProductImage} alt="Изображение товара" className="card-img" alt="..." />
						</div>
						<div className="col-md-7">
							<div className="card-body">
								<h5 className="card-title">Конструктор для детей</h5>
								<p className="card-text" style={{ overflow: 'hidden' }}>
									Супер крутое описание товара, купите здесь и сейчас. Вы, кстати, в корзине, ага.
									Вжух-вжух, купи скорей, вместе с нами веселей.
								</p>
							</div>
						</div>
